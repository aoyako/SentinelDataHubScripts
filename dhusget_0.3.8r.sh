...
# --- check HTTP response status in case of offline products download	
	http_response=`cat ./logs/log.${3}.log| grep  '\''403 Forbidden\|202 Accepted\|503 Service Unavailable\|awaiting response... 403\|awaiting response... 202\|awaiting response... 503'\''`;	
